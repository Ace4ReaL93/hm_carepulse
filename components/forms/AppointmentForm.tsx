...
const AppointmentForm= ({
  ...
  let buttonLabel;
    switch (type) {
        ...
        break;
        case "schedule":
        buttonLabel = "Programmer rendez-vous";
        break;
        default:
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 flex-1">
        {type === 'create' && <section className="mb-12 space-y-4">
            ...
            <p className="text-dark-700">Programmer un nouveau rendez-vous.</p>
        </section>}
        ...
        {type !== "cancel" && (
            ...
            >
              <CustomFormField
                ...
                control={form.control}
                name="reason"
                label="Donnez les raisons du rendez-vous"
                placeholder="..."
              />
        ...
        {type === "cancel" && (
          <CustomFormField
            ...
            label="Raisons de l'annul du rendez-vous"
